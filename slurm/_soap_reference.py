"""VERBATIM copy of https://github.com/nikhilvyas/SOAP/blob/main/soap.py (MIT).

Used only by slurm/_check_soap.py to verify that common/soap.py is a faithful
vendoring. Not imported by any production code. Do not edit.
"""
import torch
